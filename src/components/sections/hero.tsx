          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="reveal pt-4 flex flex-wrap items-center gap-4">
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 px-6 py-3.5 border border-[#424840]/30 text-[#8c9389] font-sans text-[11px] font-medium tracking-[0.2em] uppercase transition-all duration-300 hover:bg-[#424840]/10 hover:text-[#E8E6E1] hover:border-[#8c9389]/50"
              >
                <span className="shrink-0 w-4 h-4 text-[#4ade80]">
